...
class BoneSpearProjectileModel(root: ModelPart) : EntityModel<EntityRenderState>(root) {

    private val main: ModelPart = root.getChild("main")

    companion object {
        val BONE_SPEAR_MODEL_LAYER: EntityModelLayer = EntityModelLayer(id("bone_spear"), "main")
