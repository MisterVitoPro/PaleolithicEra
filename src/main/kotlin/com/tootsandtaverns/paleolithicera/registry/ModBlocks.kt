...
import com.tootsandtaverns.paleolithicera.block.KnappingStationBlock
...
object ModBlocks {
    ...
    val KNAPPING_STATION: Block = register("knapping_station", ::KnappingStationBlock, AbstractBlock.Settings.create(), true)
