...
import java.util.function.Consumer
    ...
    override fun appendTooltip(
        ...
        textConsumer.accept(Text.translatable("item.paleolithic-era.wooden_harpoon.tooltip1").formatted(Formatting.GRAY))
        textConsumer.accept(Text.translatable("item.paleolithic-era.wooden_harpoon.tooltip2").formatted(Formatting.GRAY))
