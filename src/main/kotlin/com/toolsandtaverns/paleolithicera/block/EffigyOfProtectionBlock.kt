    ...
    override fun onBlockAdded(state: BlockState, world: World, pos: BlockPos, oldState: BlockState, notify: Boolean) {
        ...
        if (!world.isClient) {
            ...
            if (!st.isOf(ModBlocks.EFFIGY_OF_PROTECTION_TOP)) {
                ...
                if (st.isAir) {
                    world.setBlockState(above, ModBlocks.EFFIGY_OF_PROTECTION_TOP.defaultState, net.minecraft.block.Block.NOTIFY_ALL)
                }
            }
        }
    }
    ...
    companion object {
        ...
        private val LOWER_SHAPE: VoxelShape by lazy {
            VoxelShapes.union(
                ...
                createCuboidShape(2.0, 8.0, 2.0, 14.0, 11.0, 14.0),  // mid rim
